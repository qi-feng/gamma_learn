...
class cnn(object):
    ...
    def read_data(self, train_x, train_y, test_x, test_y):
        self.train_x = train_x
        self.train_y = train_y
        self.test_x = test_x
        self.test_y = test_y

    def clean_negative(self, x, y=None):
    ...
    def view_layer(self, model, layer_num, data_entry, subplot_rows=4, subplot_cols=8, figsize=(12,6), cmap=plt.cm.CMRmap, filename=None):
    ...
    def read_data_from_pickle(self, fs=["64080_raw_trainx.pkl", "64080_raw_trainy.pkl", "64080_raw_testx.pkl", "64080_raw_testy.pkl"]):
    ...
    def read_all_data_from_pickle(self, runs=[64080, 64081, 64082, 64083]):
    ...
    def concat_data(self, train_x1, train_y1, test_x1, test_y1, train_x2, train_y2, test_x2, test_y2):
    ...
    def split_train_test(self, x, y, ratio=0.2, random_state=1234):
    ...
    # save model:
    def save_keras_model(self, model, filename, weight_file):
        """
        :param model:
    ...
    def predict_stats(self, model, test_x, norm=255.):
...
class cnn_regressor(cnn):
    def do_cnn_regression(self,
               ...
               filter_n3=32, filter_size3=3, filter_stride3=1, border_mode3='same', pool_size3=2, filter_drop3=0.25,
               dense_n1=256, dense_drop1=0.5, dense_n2=64, dense_drop2=0.5, batch_size=128, nb_epoch=5, norm_x=1.,
               lr=0.01, early_stop=10, weights_file= 'cnn_regressor_weights.hdf5', pool_method="avg"):
